        ...
        <div className="container-container">
          ...
          <div className="details">
              <div className="form-group">
                ...
                <input name="firstName" placeholder="First Name" value={firstName} onChange={handleUpdateFirstName} className="form-control" />
              </div>
              <div className="form-group">
                <label>Last Name</label>
                <input name="lastName" placeholder="Last Name" value={lastName} onChange={handleUpdateLastName} className="form-control" />
              </div>
          </div>
          <div className="edit-container">
            <Button
              type="primary"
              clickHandler={handleUpdatingInformation}
            >
              Update Profile
            </Button>
          </div>
